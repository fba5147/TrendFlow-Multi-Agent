...
exports.RESEARCH_PLANNING_PROMPT = exports.GALLIUM_AI_BRAND_PROMPT = void 0;
exports.getGalliumAIBrandPrompt = getGalliumAIBrandPrompt;
exports.getResearchPlanningPrompt = getResearchPlanningPrompt;
exports.getTrendSynthesisPrompt = getTrendSynthesisPrompt;
exports.getContentGenerationPrompt = getContentGenerationPrompt;
exports.getContentIdeaFormat = getContentIdeaFormat;
function getGalliumAIBrandPrompt(persona = "Growth lead at a D2C brand") {
...
exports.GALLIUM_AI_BRAND_PROMPT = getGalliumAIBrandPrompt();
function getResearchPlanningPrompt(persona = "Growth lead at a D2C brand") {
...
// Keep the constant for backward compatibility (default persona)
exports.RESEARCH_PLANNING_PROMPT = getResearchPlanningPrompt();
function getTrendSynthesisPrompt(persona = "Growth lead at a D2C brand") {
...
function getContentGenerationPrompt(platform, persona = "Growth lead at a D2C brand") {
...
function getContentIdeaFormat(persona = "Growth lead at a D2C brand") {
